...
audio_devices_t AudioPolicyManager::getDeviceForInputSource(int inputSource)
{
    ...
    case AUDIO_SOURCE_CAMCORDER:
        ...
        } else if (isInCall() && (mAvailableInputDevices & AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET)) {
            device = AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET;
        } else if (isInCall() && (mAvailableInputDevices & AUDIO_DEVICE_IN_WIRED_HEADSET)) {
            device = AUDIO_DEVICE_IN_WIRED_HEADSET;
        } else if (isInCall() && (mAvailableInputDevices & AUDIO_DEVICE_IN_AUX_DIGITAL)) {
